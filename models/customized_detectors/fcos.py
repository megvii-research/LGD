...
from .thirdparty_heads import FCOS
...
class FCOSCT(FCOS):
    ...
    def predict(self, features):
        ...
        #NOTE: permutation will executed until calculating loss
        return shifts, box_cls, box_delta, box_center
    ...
    def forward(self, batched_inputs: Tuple[Dict[str, Tensor]]):
        ...
        shifts, box_cls, box_delta, box_center = self.predict(features)
        ...
        if self.training:
            ...
            gt_classes, gt_shifts_reg_deltas, gt_centerness = \
                    self.get_ground_truth(shifts, gt_instances)
